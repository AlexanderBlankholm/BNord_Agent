#!/usr/bin/env python3
"""
Test script for the Final Excel Component Parser.
...
def test_single_file():
    ...
    print(f"Testing final parser with file: {test_file}")
    print("=" * 60)
        ...
        if result:
            ...
            if components:
                ...
                for i, comp in enumerate(components[:5]):
                    ...
                    print(f"     Materialer: {comp.get('Materialer', 'N/A')}")
                    print()
            
            # Save test output
            output_file = "test_final_output.json"
...
def main():
    """Main test function."""
    print("Final Excel Component Parser - Test Script")
    print("=" * 60)
    ...
    if success:
        ...
        print("The final parser is working correctly and ready to process all files.")
    else:
        print("\n✗ Test failed!")
